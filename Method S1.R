...
#libraries
	...
	dms<-read.csv("Data_S2_FBX_domian_information.csv",header=T)
...
############# Publication data for each FBX gene and group information
	...
	pub_fbxes<-read.csv("Data_S1_Publication_number_comparison_in_four_groups_of_fbx_genes.csv",header=T)
...
# Method 1, everyting is included	
		...
		fbx_seq_infor_df<-read.csv("Data_S3_fbx_multi_dimensional_features.csv",header=T)
